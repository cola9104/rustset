...
mod m20260324_000001_add_org_department_and_user_profile;
mod m20260325_000001_add_resource_ticket_profile_fields;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260324_000001_add_org_department_and_user_profile::Migration),
            Box::new(m20260325_000001_add_resource_ticket_profile_fields::Migration),
        ]
    }
}
