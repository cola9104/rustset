...
pub fn routes() -> Router<InfraState> {
    Router::new()
        .route("/infra/machine-room/page", get(page))
        .route("/infra/machine-room/list", get(list))
        .route("/infra/machine-room/get", get(get_one))
        .route("/infra/machine-room/create", post(create))
        .route("/infra/machine-room/update", put(update))
        .route("/infra/machine-room/delete", delete(delete_one))
        .route("/infra/machine-room/delete-list", delete(delete_list))
}
