resource "tencentcloud_instance" "requested" {
...
output "instance_ids" { value = tencentcloud_instance.requested[*].id }
output "private_ips" { value = tencentcloud_instance.requested[*].private_ip }
output "public_ips" { value = tencentcloud_instance.requested[*].public_ip }
